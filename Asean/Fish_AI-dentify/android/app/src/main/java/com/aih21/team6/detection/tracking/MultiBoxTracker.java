package com.aih21.team6.detection.tracking;
...
import com.aih21.team6.detection.tflite.Classifier.Recognition;
...
public class MultiBoxTracker {
    ...
    public synchronized void draw(final Canvas canvas) {
        ...
        for (final TrackedRecognition recognition : trackedObjects) {
            ...
            int confidence = (int) (100 * recognition.detectionConfidence);
            @SuppressLint("DefaultLocale") final String labelString =
                    !TextUtils.isEmpty(recognition.title)
                            ? String.format("%s %d", recognition.title, confidence)
                            : String.format("%d", confidence);
