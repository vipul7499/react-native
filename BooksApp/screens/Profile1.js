...
import ProfileFinal from "../components/ProfileFinal1";
...
class Profile extends Component {
  ...
  componentWillMount() {
    ...
    this.findCurrent(this.props.route.params['email']);
  ...
  componentDidMount() {
    ...
    this.books = this.props.book.filter((item) => {
      return item.email === this.props.route.params['email'];
    });
  ...
  renderPage() {
    ...
    if (this.state.addBookPage) {
      ...
      return (
        <ProfileFinal data={this.current} book={this.books}></ProfileFinal>
      );
    }
  }
